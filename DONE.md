...
## 24. Test inventory: docs/development/testing.md
...
## 25. Test inventory: docs/domdignore.md
...
## 26. Test inventory: docs/done.md
...
## 27. Command from nodejs-example.md
...
## 28. Command from nodejs-example.md
...
## 29. Test inventory: docs/features/ansible.md
...
## 30. Test inventory: docs/features/core.md
...
## 31. Test inventory: docs/how-to-llm.md
...
## 32. Test inventory: docs/installation.md
...
## 33. Test inventory: docs/mkdocs.yml
...
## 34. Test inventory: docs/todo.md
...
## 35. Test inventory: docs/usage.old.md
...
## 37. Test inventory: examples/DONE.md
...
## 38. Test inventory: examples/Makefile
...
## 39. Test inventory: examples/TODO.md
...
## 40. Test inventory: examples/docker/Dockerfile
...
## 41. Test inventory: examples/javascript/package.json
...
## 42. Test inventory: examples/package.json
...
## 43. Dynamic inventory: examples/todo.sh
...
## 46. Test inventory: pyproject.toml
...
## 47. Dynamic inventory: scripts/check_docker.sh
...
## 49. Dynamic inventory: scripts/clean_backend.sh
...
## 50. Dynamic inventory: scripts/clean_frontend.sh
...
## 51. Dynamic inventory: scripts/clean_install.sh
...
## 52. Dynamic inventory: scripts/format_backend.sh
...
column 1 (char 0). Expecting value: line 1 column 1 (char 0) Recreating
virtualenv domd in /home/tom/github/wronai/domd/.venv  [Errno 39] Directory not
empty: PosixPath('/home/tom/github/wronai/domd/.venv')
[WARNING]:  * Failed to parse
/home/tom/github/wron...
```
...
## 53. Dynamic inventory: scripts/format_frontend.sh
...
/home/tom/.npm/_logs/2025-06-18T12_00...
```
...
## 54. Dynamic inventory: scripts/install_backend.sh
...
packages/lazy_object_proxy/__init__.py over existing file Installing
/home/tom/github/wronai/domd/.venv/lib/python3.13/site-
pac...
```
...
## 57. Dynamic inventory: scripts/reset_db.sh
...
## 58. Dynamic inventory: scripts/start.sh
...
## 59. Dynamic inventory: scripts/start_frontend.sh
...
## 60. Dynamic inventory: scripts/stop.sh
...
## 61. Dynamic inventory: scripts/test_commands.sh
...
## 62. Dynamic inventory: scripts/test_commands_in_docker.py
...
## 64. Test inventory: site/mkdocs.yml
...
## 65. Test inventory: src/domd/__init__.py
...
## 66. Test inventory: src/domd/adapters/__init__.py
...
## 67. Test inventory: src/domd/adapters/api/__init__.py
...
## 68. Test inventory: src/domd/adapters/api/flask_api.py
...
## 69. Test inventory: src/domd/adapters/cli/__init__.py
...
## 70. Test inventory: src/domd/adapters/cli/command_presenter.py
...
## 71. Test inventory: src/domd/adapters/formatters/__init__.py
...
## 72. Test inventory: src/domd/adapters/formatters/markdown_formatter.py
...
## 73. Test inventory: src/domd/adapters/persistence/__init__.py
...
## 74. Test inventory: src/domd/adapters/persistence/in_memory_command_repository.py
...
## 75. Test inventory: src/domd/adapters/persistence/shell_command_executor.py
...
## 76. Dynamic inventory: src/domd/api.py
...
## 77. Test inventory: src/domd/application/__init__.py
...
## 78. Test inventory: src/domd/application/factory.py
...
## 79. Dynamic inventory: src/domd/cli.py
...
## 80. Test inventory: src/domd/command_execution/__init__.py
...
## 81. Test inventory: src/domd/core/__init__.py
...
## 82. Test inventory: src/domd/core/command_execution/__init__.py
...
## 83. Test inventory: src/domd/core/detector.py
...
## 84. Test inventory: src/domd/core/domain/__init__.py
...
## 85. Test inventory: src/domd/core/domain/command.py
...
## 86. Test inventory: src/domd/core/parsing/__init__.py
...
## 87. Test inventory: src/domd/core/ports/__init__.py
...
## 88. Test inventory: src/domd/core/ports/command_executor.py
...
## 89. Test inventory: src/domd/core/ports/command_repository.py
...
## 90. Test inventory: src/domd/core/ports/report_formatter.py
...
## 91. Test inventory: src/domd/core/reporting/__init__.py
...
## 92. Test inventory: src/domd/core/services/__init__.py
...
## 93. Test inventory: src/domd/core/services/command_service.py
...
## 94. Test inventory: src/domd/core/services/report_service.py
...
## 95. Test inventory: src/domd/core/utils/__init__.py
...
## 96. Test inventory: src/domd/core/utils/command_utils.py
...
## 97. Test inventory: src/domd/core/utils/file_utils.py
...
## 98. Test inventory: src/domd/parsers/__init__.py
...
## 99. Test inventory: src/domd/parsers/base.py
...
## 100. Test inventory: src/domd/parsers/ci_cd.py
...
## 101. Test inventory: src/domd/parsers/docker.py
...
## 102. Test inventory: src/domd/parsers/javascript.py
...
## 103. Test inventory: src/domd/parsers/test_ci_cd.py
...
## 104. Test inventory: src/domd/parsers/test_docker.py
...
## 105. Test inventory: src/domd/parsers/test_javascript.py
...
## 106. Test inventory: src/domd/parsers/test_python.py
...
## 107. Test inventory: src/domd/parsing/__init__.py
...
## 108. Test inventory: src/domd/reporters/console.py
...
## 109. Test inventory: src/domd/reporters/json_reporter.py
...
## 110. Test inventory: src/domd/reporters/test_console.py
...
## 111. Test inventory: src/domd/reporters/test_json_reporter.py
...
## 112. Test inventory: src/domd/reporters/test_todo_md.py
...
## 113. Test inventory: src/domd/reporters/todo_md.py
...
## 114. Test inventory: src/domd/reporting/__init__.py
...
## 115. Test inventory: src/domd/utils/command_runner.py
...
## 116. Test inventory: src/domd/utils/file_utils.py
...
## 117. Test inventory: src/domd/utils/test_command_runner.py
...
## 118. Test inventory: src/domd/utils/test_file_utils.py
...
## 119. Dynamic inventory: test_in_docker.sh
...
## 120. Test inventory: tests/ansible/roles/login_test/tasks/main.yml
...
## 121. Test inventory: tests/ansible/test_login.yml
...
## 122. Test inventory: tests/conftest.py
...
## 123. Test inventory: tests/fixtures/__init__.py
...
## 124. Test inventory: tests/fixtures/ansible_helpers.py
...
## 125. Test inventory: tests/fixtures/sample_dockerfile
...
## 126. Test inventory: tests/fixtures/sample_makefile
...
## 127. Test inventory: tests/fixtures/sample_package.json
...
## 128. Test inventory: tests/fixtures/sample_pyproject.toml
...
## 129. Test inventory: tests/parsers/__init__.py
...
## 130. Test inventory: tests/reporters/__init__.py
...
## 131. Test inventory: tests/test_ansible.py
...
## 132. Test inventory: tests/test_ansible_galaxy.py
...
## 133. Test inventory: tests/test_ansible_inventory.py
...
## 134. Test inventory: tests/test_ansible_playbook.py
...
## 135. Test inventory: tests/test_ansible_roles.py
...
## 136. Test inventory: tests/test_ansible_vault.py
...
## 137. Test inventory: tests/test_cli.py
...
## 138. Test inventory: tests/test_detector.py
...
## 139. Test inventory: tests/unit/core/detector/test_project_command_detector.py
...
## 140. Test inventory: tests/unit/parsers/test_base_parser.py
...
## 141. Test inventory: tests/unit/parsers/test_config_parsers.py
...
## 142. Test inventory: tests/unit/reporters/test_todo_md_reporter.py
...
## 143. Test inventory: tests/utils/__init__.py
