...
error: /home/tom/github/wronai/domd/.venv/bin/python: No module named build
[WARNING]:  * Failed to parse /home/tom/github/wronai/domd/docker-
test/test_install.sh with ini plugin: /home/tom/github/wronai/domd/docker-
test/test_install.sh:2: Expected key=value host variable assignment, got: -e
[WAR...
```
...
## 21. Test inventory: docs/development/testing.md
...
## 22. Test inventory: docs/domdignore.md
...
## 23. Test inventory: docs/done.md
...
## 24. Command from nodejs-example.md
...
## 25. Command from nodejs-example.md
...
## 26. Test inventory: docs/features/ansible.md
...
## 27. Test inventory: docs/features/core.md
...
## 28. Test inventory: docs/how-to-llm.md
...
## 29. Test inventory: docs/installation.md
...
## 30. Test inventory: docs/mkdocs.yml
...
## 31. Test inventory: docs/todo.md
...
## 32. Test inventory: docs/usage.old.md
...
## 34. Test inventory: examples/DONE.md
...
## 35. Test inventory: examples/Makefile
...
## 36. Test inventory: examples/TODO.md
...
## 37. Test inventory: examples/docker/Dockerfile
...
## 38. Test inventory: examples/javascript/package.json
...
## 39. Test inventory: examples/package.json
...
## 40. Dynamic inventory: examples/todo.sh
...
## 43. Test inventory: pyproject.toml
...
## 44. Dynamic inventory: scripts/check_version.py
...
## 45. Dynamic inventory: scripts/clean_install.sh
...
## 46. Test inventory: scripts/publish.sh
...
## 47. Dynamic inventory: scripts/run_tests.sh
...
[WARNING]:  * Failed to parse /home/tom/github/wronai/domd/scripts/run_tests.sh
with ini plugin: /home/tom/github/wronai/domd/scripts/run_tests.sh:4: Expected
key=value host variable assignment, got: Running...
```
...
## 48. Dynamic inventory: scripts/test_commands.sh
...
## 49. Test inventory: site/mkdocs.yml
...
## 50. Test inventory: src/domd/adapters/api/flask_api.py
...
## 51. Test inventory: src/domd/adapters/cli/command_presenter.py
...
## 52. Test inventory: src/domd/adapters/formatters/markdown_formatter.py
...
## 53. Dynamic inventory: src/domd/api.py
...
## 54. Test inventory: src/domd/application/factory.py
...
## 55. Dynamic inventory: src/domd/cli.py
...
## 56. Test inventory: src/domd/core/detector.py
...
## 57. Test inventory: src/domd/core/domain/command.py
...
## 58. Test inventory: src/domd/core/ports/command_executor.py
...
## 59. Test inventory: src/domd/core/ports/command_repository.py
...
## 60. Test inventory: src/domd/core/ports/report_formatter.py
...
## 61. Test inventory: src/domd/core/services/command_service.py
...
## 62. Test inventory: src/domd/core/services/report_service.py
...
## 63. Test inventory: src/domd/core/utils/command_utils.py
...
## 64. Test inventory: src/domd/core/utils/file_utils.py
...
## 65. Test inventory: src/domd/parsers/base.py
...
## 66. Test inventory: src/domd/parsers/ci_cd.py
...
## 67. Test inventory: src/domd/parsers/docker.py
...
## 68. Test inventory: src/domd/parsers/javascript.py
...
## 69. Test inventory: src/domd/parsers/test_docker.py
...
## 70. Test inventory: src/domd/parsers/test_javascript.py
...
## 71. Test inventory: src/domd/parsers/test_python.py
...
## 72. Test inventory: src/domd/reporters/console.py
...
## 73. Test inventory: src/domd/reporters/json_reporter.py
...
## 74. Test inventory: src/domd/reporters/test_console.py
...
## 75. Test inventory: src/domd/reporters/todo_md.py
...
## 76. Test inventory: src/domd/utils/command_runner.py
...
## 77. Test inventory: src/domd/utils/file_utils.py
...
## 78. Test inventory: tests/ansible/roles/login_test/tasks/main.yml
...
## 79. Test inventory: tests/ansible/test_login.yml
...
## 80. Test inventory: tests/conftest.py
...
## 81. Test inventory: tests/fixtures/ansible_helpers.py
...
## 82. Test inventory: tests/fixtures/sample_dockerfile
...
## 83. Test inventory: tests/fixtures/sample_makefile
...
## 84. Test inventory: tests/fixtures/sample_package.json
...
## 85. Test inventory: tests/fixtures/sample_pyproject.toml
...
## 86. Test inventory: tests/test_ansible.py
...
## 87. Test inventory: tests/test_cli.py
...
## 88. Test inventory: tests/test_detector.py
